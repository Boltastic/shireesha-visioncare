...
function Appointments() {
  ...
  const update = trpc.admin.appointments.updateStatus.useMutation({ onSuccess: () => { utils.admin.appointments.list.invalidate(); notify({ kind: "success", title: "Appointment updated", message: "The appointment status has been saved." }); }, onError: error => notify({ kind: "error", title: "Status update failed", message: error.message }) });
  const reschedule = trpc.admin.appointments.reschedule.useMutation({ onSuccess: () => { setRescheduleId(undefined); utils.admin.appointments.list.invalidate(); notify({ kind: "success", title: "Appointment rescheduled", message: "The new time is now saved." }); }, onError: error => notify({ kind: "error", title: "Rescheduling failed", message: error.message }) });
...
function Services() {
  ...
  const create = trpc.admin.services.create.useMutation({ onSuccess: () => { setName(""); utils.admin.services.list.invalidate(); notify({ kind: "success", title: "Service added", message: "The service is available in staff management." }); }, onError: error => notify({ kind: "error", title: "Service could not be added", message: error.message }) });
  const toggle = trpc.admin.services.toggle.useMutation({ onSuccess: (_, values) => { utils.admin.services.list.invalidate(); notify({ kind: "success", title: values.active ? "Service activated" : "Service paused", message: "Public booking availability has been updated." }); }, onError: error => notify({ kind: "error", title: "Service update failed", message: error.message }) });
...
function Settings() {
  ...
  const utils = trpc.useUtils(); const update = trpc.admin.settings.update.useMutation({ onSuccess: () => { utils.admin.settings.list.invalidate(); notify({ kind: "success", title: "Setting saved", message: "Your booking configuration has been updated." }); }, onError: error => notify({ kind: "error", title: "Setting update failed", message: error.message }) });
...
function AvailabilityEditor() {
  ...
  const save = trpc.admin.availability.saveRule.useMutation({ onSuccess: () => { utils.admin.availability.list.invalidate(); notify({ kind: "success", title: "Availability saved", message: "The booking calendar has been updated." }); }, onError: error => notify({ kind: "error", title: "Availability update failed", message: error.message }) });
